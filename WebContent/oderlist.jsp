...
<body>
	...
	<div class="cart-thead x">
		...
		<div class="column t-price">数量</div>
		<div class="column t-quantity">小计</div>
		<div class="column t-sum">状态</div>
	...
	<div class="item-form x">
		...
		<div class="cell p-price">
			<strong>¥<%=i.getNum()%></strong>
		</div>

		<div class="cell p-quantity">¥<%=i.getNum() * i.getGoods().getGprice()%></div>
